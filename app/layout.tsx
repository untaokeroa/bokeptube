...
export const metadata: Metadata = {
    ...
    metadataBase: new URL("https://bokeptube.pages.dev"),
    alternates: {
        canonical: `/`,
    },
    openGraph: {
    ...
    verification: {
        google: '1X97qZeja-lx6_e1lnVxBkoGkzYocd_m_i9TFRcp1XA',
        yandex: '7bf0927e45fee91b',
    },
};
...
export default function RootLayout({
    ...
    const jsonLd = {
        ...
        "url": "https://bokeptube.pages.dev",
        "description": `${SITENAME} Video bokep indo jepang indonesia barat terbaru viral korea simontok china tante live sma paksa ngentot abg jilbab cewek bocil smp pijat pelajar.`,
        "image": "https://bokeptube.pages.dev/favicon.ico",
        "potentialAction":{
            "@type":"ReadAction",
            "target":"https://bokeptube.pages.dev"}
        }
        const jsonLd2 = {
            "@context": "https://schema.org",
        "@type": "WebSite",
        ...
        "potentialAction": { 
        "@type": "SearchAction", 
          "target": "https://bokeptube.pages.dev/?q={search_term}", 
